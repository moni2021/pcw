...
export default function AdminPage() {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
            title: "Changes Saved!",
            description: "Your updates have been saved successfully. You may need to refresh the homepage to see changes.",
        });
      } else {
  ...
  const handleJsonUpdate = () => {
    ...
    try {
        ...
        toast({
            title: "Data Loaded",
            description: "JSON data has been loaded into the editor. Review and click 'Save All Changes' to persist them.",
        });
    } catch (error: any) {
                    ...
                    <AccordionItem value={serviceType}>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <Button type="button" size="sm" variant="outline" onClick={() => handleAddItem(serviceType, 'parts')}>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className="text-right">
                                                <Button type="button" variant="ghost" size="icon" onClick={() => handleRemoveItem(serviceType, 'parts', index)}>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <Button type="button" size="sm" variant="outline" onClick={() => handleAddItem(serviceType, 'labor')}>
                                ...
                                <div className="overflow-x-auto border rounded-lg">
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className="text-right">
                                                <Button type="button" variant="ghost" size="icon" onClick={() => handleRemoveItem(serviceType, 'labor', index)}>
                                                    <Trash2 className="h-4 w-4 text-destructive" />
                                                </Button>
                                            </TableCell>
                                        </TableRow>
                         ...
                         <div className="mt-8">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <Button type="button" size="sm" variant="outline" onClick={() => handleAddItem(serviceType, 'recommendedLabor')}>
                                ...
                                <div className="overflow-x-auto border rounded-lg">
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className="text-right">
                                                <Button type="button" variant="ghost" size="icon" onClick={() => handleRemoveItem(serviceType, 'recommendedLabor', index)}>
                                                    <Trash2 className="h-4 w-4 text-destructive" />
                                                </Button>
                                            </TableCell>
                                        </TableRow>
                        ...
                        <div className="mt-8">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <Button type="button" size="sm" variant="outline" onClick={() => handleAddItem(serviceType, 'optionalServices')}>
                                ...
                                <div className="overflow-x-auto border rounded-lg">
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell className="text-right">
                                                <Button type="button" variant="ghost" size="icon" onClick={() => handleRemoveItem(serviceType, 'optionalServices', index)}>
                                                    <Trash2 className="h-4 w-4 text-destructive" />
                                                </Button>
                                            </TableCell>
                                        </TableRow>
                        ...
                        <AccordionContent className="px-6 pt-4 space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mb-4">
                                    You can edit the entire service data object below. Click 'Load JSON Data' to apply changes to the editor above, then 'Save All Changes' to persist them.
                                </p>
                                 <Textarea 
                            ...
                            <Button type="button" onClick={handleJsonUpdate} className="mt-4">Load JSON Data into Editor</Button>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
             </Card>
