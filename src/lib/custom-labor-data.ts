...
export const customLaborData: CustomLabor[] = [
  { name: 'BATTERY GROUND CABLE', model: 'Ertiga', charge: 250.16 },
  { name: 'BATTERY GROUND CABLE', model: 'Celerio', charge: 274.03 },
  { name: 'BATTERY GROUND CABLE', model: 'Wagon R', charge: 274.03 },
  ...
  { name: 'BATTERY GROUND CABLE', model: 'Eeco', charge: 92 },
  { name: 'BATTERY GROUND CABLE', model: 'Dzire', charge: 290.38 },
  ...
  { name: 'FRONT SUSPENSION ARM (ONE SIDE) WITH OPPOSITE SIDE', model: 'Brezza', charge: 590 },
  ...
  { name: 'FRONT STABILIZER BAR JOINT (ONE SIDE) WITH OPPOSITE SIDE', model: 'Brezza', charge: 236 },
  ...
  { name: 'FRONT BRAKE CALIPER ASSY (ONE SIDE) WITH OPPOSITE SIDE', model: 'Super Carry', charge: 174.02 },
  ...
  { name: 'FRONT DISC BRAKE PAD (BOTH SIDES)', model: 'Baleno', charge: 287.5 },
  ...
  { name: 'STONE GUARD COATING', model: 'Wagon R', charge: 650 },
