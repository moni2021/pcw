...
const freeService3: string[] = ['ENGINE_OIL', 'Oil Filter', 'Drain Plug Gasket'];

const base_10k: string[] = ['ENGINE_OIL', 'Oil Filter', 'Drain Plug Gasket'];
const p_parts_20k: string[] = [...base_10k, 'Air Filter', 'A/C Filter', 'Brake Fluid'];
const p_parts_30k: string[] = [...base_10k, 'COOLANT PREMIX GOLDEN YELLOW', 'Brake Fluid'];
const p_parts_40k: string[] = [...p_parts_20k, 'Fuel Filter', 'Spark Plugs'];
const p_parts_60k: string[] = [...p_parts_20k, 'Transmission Fluid'];

const d_parts_20k: string[] = ['ECSTAR DIESEL 5W30-IOCL', 'Oil Filter', 'Drain Plug Gasket', 'Air Filter', 'A/C Filter', 'Brake Fluid', 'Diesel Filter'];
const d_parts_30k: string[] = ['ECSTAR DIESEL 5W30-IOCL', 'Oil Filter', 'Drain Plug Gasket', 'COOLANT PREMIX GOLDEN YELLOW', 'Brake Fluid'];
const d_parts_40k: string[] = [...d_parts_20k];
const d_parts_60k: string[] = [...d_parts_20k, 'Transmission Fluid'];


export const schedules: Record<string, ServiceSchedule> = {
...
export const modelToScheduleMap: VehicleScheduleMapping = {
